			...
			<div class="card mt-3">
				...
				<div class="container md-6 md-offset-2">
					<form action="processproduct" method="POST">
						<div class="form-group">
							<label for="exampleInputEmail1">Product Name</label> <input
								...
								name="name" placeholder="Enter Name of product">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Product Description</label>
							<textarea class="form-control" rows="4" name="description"
								id="exampleInputPassword1" placeholder="Enter description"></textarea>
						</div>
						<div class="form-group">
					...
					<div class="text-center mt-3">
						<a href="/ProductCrudApp/"><button 
								type="submit" class="btn btn-outline-success">Back</button></a>
					</div>
				</div>
			</div>
		</div>
